 ...
 * Última actualización: domingo, 15 de marzo de 2026, 06:18 p. m.
...
export const zonaA: EquipoTabla[] = [
    { nombre: 'Vélez', pj: 10, pts: 22, dif: 7 },
    { nombre: 'Unión', pj: 9, pts: 15, dif: 6 },
    { nombre: 'Estudiantes', pj: 9, pts: 15, dif: 3 },
    { nombre: 'Talleres', pj: 10, pts: 15, dif: 1, esTalleres: true },
    { nombre: 'Independiente', pj: 9, pts: 14, dif: 4 },
    { nombre: 'Platense', pj: 10, pts: 14, dif: 0 },
...
export const zonaB: EquipoTabla[] = [
    { nombre: 'Ind. Rivadavia', pj: 10, pts: 20, dif: 4 },
    { nombre: 'Belgrano', pj: 10, pts: 19, dif: 4 },
    { nombre: 'Central', pj: 10, pts: 18, dif: 5 },
    { nombre: 'Tigre', pj: 9, pts: 16, dif: 7 },
    { nombre: 'River', pj: 9, pts: 14, dif: 1 },
    { nombre: 'Gimnasia', pj: 10, pts: 14, dif: -1 },
    ...
    { nombre: 'Banfield', pj: 10, pts: 10, dif: -2 },
...
export const promedios: EquipoTabla[] = [
    ...
    { nombre: 'Vélez', pj: 83, pts: 138, dif: 1.663 },
    { nombre: 'Racing', pj: 82, pts: 135, dif: 1.646 },
    { nombre: 'Central', pj: 83, pts: 131, dif: 1.578 },
    ...
    { nombre: 'Talleres', pj: 83, pts: 121, dif: 1.458, esTalleres: true },
    ...
    { nombre: 'Ind. Rivadavia', pj: 83, pts: 109, dif: 1.313 },
    { nombre: 'Riestra', pj: 82, pts: 106, dif: 1.293 },
    { nombre: 'Platense', pj: 83, pts: 106, dif: 1.277 },
    { nombre: 'Tigre', pj: 82, pts: 104, dif: 1.268 },
    { nombre: 'Belgrano', pj: 83, pts: 105, dif: 1.265 },
    { nombre: 'Gimnasia', pj: 83, pts: 100, dif: 1.205 },
    ...
    { nombre: 'Banfield', pj: 83, pts: 86, dif: 1.036 },
